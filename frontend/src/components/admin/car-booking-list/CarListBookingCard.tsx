                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                                <span>Pickup: {new Date(searchKey.pickUpDateTime).toLocaleString()}</span>
                                <span className="text-gray-400">→</span>
                                <span>Return: {new Date(searchKey.dropOffDateTime).toLocaleString()}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm">
                                            ...
                                            <span className="font-medium text-gray-900">{booking.vehicle_id}</span>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            <span className="text-gray-600">Duration:</span>
                                            <span className="font-medium text-gray-900">{searchKey.rentalDurationInDays} days</span>
                                        </div>
                                        <div className="flex justify-between text-sm">
                                            <span className="text-gray-600">Driver's Age:</span>
                                            <span className="font-medium text-gray-900">{searchKey.driversAge} years</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
