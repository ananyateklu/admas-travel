...
export function FlightDetailsModal({ flight, onClose }: FlightDetailsModalProps) {
    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 bg-black/50 z-[60] flex items-start justify-center pt-28 pb-6 px-6" onClick={onClose}>
                <motion.div
                ...
                >
                    ...
                    <div className="p-3 bg-gray-50 border-t border-gray-100">
                        <div className="flex justify-end gap-2">
                            ...
                            <button className="px-3 py-1.5 text-sm bg-gold text-white rounded-lg hover:bg-gold/90 transition-colors">
                                Book Flight
                            </button>
                        </div>
                    </div>
