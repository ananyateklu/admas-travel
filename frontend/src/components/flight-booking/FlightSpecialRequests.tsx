        ...
        <div className="bg-white rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
            <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200">
                <div className="flex items-center gap-1.5">
                    ...
                    <div>
                        <h4 className="text-[11px] font-medium text-gray-700">Special Requests</h4>
            ...
            <div className="p-3">
                <div className="relative">
                    <textarea
                        ...
                        className="w-full px-2 py-1.5 text-[11px] border border-gray-200 hover:border-gray-300 rounded-lg 
                            focus:ring-1 focus:ring-primary/30 focus:border-primary focus:outline-none 
