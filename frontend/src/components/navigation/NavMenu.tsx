            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="fixed top-[112px] left-4 z-50 w-[600px]"
                    >
                        <motion.div
                        ...
                        >
                            <div className="grid grid-cols-2 gap-px bg-gray-100/50 p-1">
                                ...
                                <motion.div
                                    ...
                                    className="bg-white rounded-xl p-3 space-y-3"
                                >
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        <motion.a
                                            ...
                                            className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors group relative overflow-hidden"
                                        >
                                            <motion.span
                                            ...
                                            <div>
                                                <span className="block text-sm font-medium text-gray-900">Call us</span>
                                                <span className="text-[10px] text-gray-500">+1 (612) 743-7243</span>
                                            </div>
                                        </motion.a>
                                        ...
                                        {!user && (
                                            ...
                                            >
                                                ...
                                                >
                                                    <motion.span
                                                        className="p-1.5 rounded-lg bg-indigo-50 text-indigo-600 group-hover:bg-indigo-100 transition-colors"
                                                        whileHover={{ rotate: -15 }}
                                                    >
                                                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-[10px] text-gray-500">Access your account</span>
                                                    </div>
                                                </Link>
                                            </motion.div>
                                        )}
                                        ...
                                        >
                                            <Link
                                                to="/get-started"
                                                onClick={onClose}
                                                className="flex items-center gap-3 p-2 bg-[#1A1A1A] rounded-lg hover:bg-black transition-colors group relative overflow-hidden"
                                            >
                                                <motion.span
                                                ...
                                                <div>
                                                    <span className="block text-sm font-medium text-white">Get Started</span>
                                                    <span className="text-[10px] text-gray-400">Begin your adventure</span>
                                                </div>
                                            </Link>
                                        </motion.div>
                                    </div>
