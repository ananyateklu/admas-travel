            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="fixed top-[100px] left-4 z-50 w-[540px]"
                    >
                        <motion.div
                        ...
                        >
                            <div className="grid grid-cols-2 gap-px bg-gray-100/50 p-1">
                                ...
                                <motion.div
                                    ...
                                    className="bg-white rounded-lg p-2.5 space-y-2.5"
                                >
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-xs font-medium text-gray-900">Quick Actions</h3>
                                        <motion.div
                                    ...
                                    <div className="space-y-1.5">
                                        <motion.a
                                            ...
                                            className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-gray-50 transition-colors group relative overflow-hidden"
                                        >
                                            <motion.span
                                        ...
                                        {!user && (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <span className="block text-xs font-medium text-gray-900">Sign In</span>
                                        ...
                                        >
                                            <Link
                                                to="/get-started"
                                                onClick={onClose}
                                                className="flex items-center gap-2.5 p-2 bg-[#1A1A1A] rounded-lg hover:bg-black transition-colors group relative overflow-hidden"
                                            >
                                                <motion.span
