        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    animate="visible"
                    exit="exit"
                    className="absolute top-[5.5rem] right-4 z-50 w-[250px]"
                >
                    <motion.div
                            ...
                            >
                                {user.photoURL ? (
                                    ...
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, scale: 1 }}
                                        transition={{ type: 'spring', stiffness: 300, damping: 20 }}
                                        className="w-12 h-12 rounded-xl bg-primary-50 text-primary flex items-center justify-center ring-2 ring-white/50"
                                    >
                                        <motion.span
                                            initial={{ opacity: 0, scale: 0.5 }}
                                            animate={{ opacity: 1, scale: 1 }}
                                ...
                                <motion.div variants={itemVariants}>
                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            ...
                                            <span className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-200">View your account</span>
                                        </div>
                                    </Link>
                                </motion.div>
