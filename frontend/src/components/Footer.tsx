            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-serif">Admas Travel</h3>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://touristlife.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors -mt-0.5">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/trips" className="text-sm text-gray-400 hover:text-white transition-colors">
                                    Our Trips
                                </Link>
                            </li>
                            <li>
                                <Link to="/about-us" className="text-sm text-gray-400 hover:text-white transition-colors">
                                    About Us
                                </Link>
                            </li>
                            <li>
                                <Link to="/book" className="text-sm text-gray-400 hover:text-white transition-colors">
                                    Book
                                </Link>
                            </li>
                            <li>
                                <Link to="/get-started" className="text-sm text-gray-400 hover:text-white transition-colors">
                                    Get Started
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <form className="space-y-2">
                            <input
                                ...
                                className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white placeholder-gray-400 focus:outline-none focus:border-white"
                            />
                            <button
                                type="submit"
                                className="w-full px-4 py-2 bg-white text-gray-900 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors"
                            >
                                Subscribe
                            </button>
                        </form>
