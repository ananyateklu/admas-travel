...
export function BookingReview({ formData }: BookingReviewProps) {
    ...
    return (
        <div className="space-y-6">
            {/* Journey Timeline */}
            <div className="bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                        <h3 className="text-xs font-medium text-gray-900">Journey Timeline</h3>
                        <p className="text-[10px] text-gray-500">Your travel schedule</p>
                    </div>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 relative">
                            <div className="flex items-center gap-1.5">
                                <div className="w-1.5 h-1.5 rounded-full bg-gold flex-shrink-0 relative z-10"></div>
                                <div className="flex-1 bg-gold/5 rounded-lg py-1 px-2">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-xs font-medium text-gray-900">{formData.from?.city}</p>
                                            <div className="flex items-center gap-1">
                                                <p className="text-[10px] text-gray-500">Departure</p>
                                                <span className="text-[10px] text-gray-400">•</span>
                                                <span className="text-[10px] text-gray-500">{formatTime(formData.departureTime)}</span>
                                            </div>
                                        </div>
                        ...
                        <div className="flex-shrink-0 w-12 relative">
                            ...
                            <div className="absolute left-1/2 -translate-x-1/2 -translate-y-[2px] text-[10px] text-gray-400">
                        ...
                        <div className="flex-1 relative">
                            <div className="flex items-center gap-1.5">
                                ...
                                <div className="flex-1 bg-emerald-50 rounded-lg py-1 px-2">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-xs font-medium text-gray-900">{formData.to?.city}</p>
                                            <div className="flex items-center gap-1">
                    ...
                    {formData.tripType === 'roundtrip' && formData.returnDate && formData.returnTime && (
                        <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1 bg-blue-50 rounded-lg py-1 px-2">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <p className="text-xs font-medium text-gray-900">{formData.to?.city}</p>
                                                <div className="flex items-center gap-1">
                                                    <p className="text-[10px] text-gray-500">Return Departure</p>
                                                    <span className="text-[10px] text-gray-400">•</span>
                                                    <span className="text-[10px] text-gray-500">{formatTime(formData.returnTime)}</span>
                                                </div>
                                            </div>
                            ...
                            <div className="flex-1 relative">
                                <div className="flex items-center gap-1.5">
                                    <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 flex-shrink-0 relative z-10"></div>
                                    <div className="flex-1 bg-indigo-50 rounded-lg py-1 px-2">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <p className="text-xs font-medium text-gray-900">{formData.from?.city}</p>
                                                <div className="flex items-center gap-1">
                                                    <p className="text-[10px] text-gray-500">Return Arrival</p>
                                                    <span className="text-[10px] text-gray-400">•</span>
                                                    <span className="text-[10px] text-gray-500">{formatTime(formData.returnTime)}</span>
                                                </div>
                                            </div>
            ...
            <div className="grid grid-cols-12 gap-4">
                {/* Trip Details */}
                <div className="col-span-12 lg:col-span-4 bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div className="flex items-center gap-2 mb-3">
                        <div className="p-1.5 bg-gold/10 rounded-lg">
                            <svg className="w-3.5 h-3.5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3 className="text-xs font-medium text-gray-900">Trip Details</h3>
                            <p className="text-[10px] text-gray-500">Flight information</p>
                        </div>
                    </div>
                ...
                <div className="col-span-12 lg:col-span-4 bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <div>
                            <h3 className="text-xs font-medium text-gray-900">Passenger Details</h3>
                        ...
                        {formData.passengers.map((passenger, index) => (
                            ...
                            >
                                <div className="flex items-center gap-1.5 mb-1.5">
                                    ...
                                    <div>
                                        <div className="text-xs font-medium text-gray-900">{passenger.fullName}</div>
                                        <div className="text-[10px] text-gray-500 capitalize">{passenger.type}</div>
                                    </div>
                                </div>
                ...
                <div className="col-span-12 lg:col-span-4 bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <div>
                            <h3 className="text-xs font-medium text-gray-900">Contact Information</h3>
                    ...
                    <div className="space-y-1.5">
                        <div className="p-1.5 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-xs font-medium text-gray-900">{formData.contactName}</div>
                        </div>
                        <div className="p-1.5 bg-gray-50 rounded-lg">
                            <div className="text-[10px] text-gray-500">Email</div>
                            <div className="text-xs font-medium text-gray-900">{formData.contactEmail}</div>
                        </div>
                        <div className="p-1.5 bg-gray-50 rounded-lg">
                            <div className="text-[10px] text-gray-500">Phone</div>
                            <div className="text-xs font-medium text-gray-900">{formData.contactPhone}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {formData.specialRequests && (
                <div className="bg-white rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <div>
                            <h3 className="text-xs font-medium text-gray-900">Special Requests</h3>
                            <p className="text-[10px] text-gray-500">Additional requirements</p>
                        </div>
                    </div>
                    <div className="p-2 bg-gray-50 rounded-lg text-xs text-gray-700 whitespace-pre-wrap">
                        {formData.specialRequests}
                    </div>
                </div>
            )}
