...
export function PassengerCount({
    ...
    const renderCounter = (
        ...
        <div className="p-1 rounded-lg border border-gray-300 hover:border-gray-400 transition-colors">
            <div className="flex justify-between items-center">
                <div>
                    <div className="text-xs font-medium text-gray-700">{label}</div>
                    {helpText && <div className="text-[10px] text-gray-400">{helpText}</div>}
                </div>
        ...
        <div className="bg-white rounded-lg border border-gray-300 hover:border-gray-400 transition-colors">
            <div className="flex items-center justify-between px-3 py-2 border-b border-gray-300">
                <div className="flex items-center gap-1.5">
                    ...
                    <h4 className="text-xs font-medium text-gray-700">Passenger Count</h4>
                </div>
            </div>

            <div className="space-y-2 p-3">
                <div>
                    <h3 className="text-[10px] font-medium text-gray-500 mb-1">Passenger Type</h3>
                ...
                <div>
                    <h3 className="text-[10px] font-medium text-gray-500 mb-1">Travel Class</h3>
                        ...
                        {cabinOptions.map((option) => (
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className={`w-3 h-3 rounded-full border-2 flex items-center justify-center ${cabinClass === option.value
                                        ? 'border-gold'
                                        : 'border-gray-300'
                                        }`}>
